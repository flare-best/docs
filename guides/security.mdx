...
<Steps>
    ...
    <Step title="Click on Enable 2FA">
        ...
        <Frame>
            ![2FA Setting](../assets/images/2fa-settings.png)
        </Frame>
    </Step>
    <Step title="Save your Recovery Code">
        ...
        <Frame>
            ![2FA Recovery](../assets/images/2fa-recovery.png)
        </Frame>        
    </Step>
    <Step Title="Scan the QR code or enter the secret key in your authenticator app">
        ...
        <Frame>
            ![2FA Key](../assets/images/2fa-key.png)
        </Frame>  
    </Step>
    <Step Title="Enter your verification code">
        ...
        <Frame>
            ![2FA Verify](../assets/images/2fa-verify.png)
        </Frame>  
    </Step>
</Steps>
...
<Steps>
    ...
    <Frame>
        ![2FA Lost](../assets/images/2fa-lost.png)
    </Frame>              
    </Step>
