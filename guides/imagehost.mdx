...
<Frame>
  ![General Image Host Customization Interface](../assets/images/imagehost_general_customization.png)
</Frame>
...
<Steps>
  <Step title="Locate Domain Manager Button">
    <Frame>
      ![Domain Manager Button](../assets/images/domain-manager-01.png)
    </Frame>
  </Step>
  <Step title="Domain Manager Interface">
    Here you can see all available domains for the image host.
    <Frame>
      ![Domain Manager Button](../assets/images/domain-manager-02.png)
    </Frame>
  </Step>
</Steps>

<Tip>
If you’d like to suggest a domain, [join our Discord server](https://discord.gg/hauntbio). To donate a domain, view [Custom Domain Settings](../guides/imagehost#domain-settings-custom-domain).
</Tip>
...
<Steps>
  ...
  <Step title="Start adding your domain">
    You'll find a form to add your custom domain(s).

    Enter your domain url in the Domain box.  
    Choose the Visibility of your domain, then hit “Add Domain”.

    <Frame>
      ![Domain Configuration Popup](../assets/images/Domain-Config-popup.png)
    </Frame>
  </Step>
  ...
  <Step title="Configure your DNS">
    ...
    <Frame>
      ![Cloudflare DNS Records](../assets/images/cloudflarednsrecords.png)
    </Frame>
    ...
    <Frame>
      ![Add DNS Record](../assets/images/domain-linker-add-record.png)
    </Frame>

    After this go back to your image-host dashboard and open back the pop-up by clicking “Open DNS Setup” in “Your Domains”.

    <Frame>
      ![Waiting for DNS Setup](../assets/images/YourDomains-List-WaitingForDNSsetup.png)
    </Frame>
  </Step>
  ...
  <Step title="Verify your domain">
    ...
    <Frame>
      ![Verify Domain Button](../assets/images/VerifyDomainButtonList.png)
    </Frame>

    If you see this then you're good to go !

    <Frame>
      ![Domain Linked Successfully](../assets/images/YourDomains-List-Completed.png)
    </Frame>

    However if you got any error then please double check if u use Cloudflare that the record is DNS only and not proxied.

    <Frame>
      ![DNS Record DNS Only](../assets/images/dns-record.png)
    </Frame>
    ...
    <Frame>
      ![DNS Checker](../assets/images/dns-checker.png)
    </Frame>
  </Step>
</Steps>
---
...
<Frame>
  ![Config File](../assets/images/sharex-01.png)
</Frame>
</Step>
...
<Frame>
  ![Custom uploader confirmation](../assets/images/sharex-02.png)
</Frame>
</Step>
...
<Frame>
  ![Keyboard Shortcuts](../assets/images/sharex-03.png)
</Frame>
</Step>
...
<Frame>
  ![After capture tasks](../assets/images/sharex-04.png)
</Frame>
</Step>
...
<Frame>
  ![After upload tasks](../assets/images/sharex-05.png)
</Frame>
</Step>
...
<Frame>
  ![Destinations settings](../assets/images/sharex-06.png)
</Frame>
</Step>
...
<Frame>
  ![Custom uploader settings button](../assets/images/sharex-07.png)
</Frame>
</Step>
...
<Frame>
  ![Custom uploader settings](../assets/images/sharex-08.png)
</Frame>
</Step>
...
<Frame>
  ![Download iShare](../assets/images/ishare-01.png)
</Frame>
</Accordion>
...
<Frame>
  ![Import Custom Uploader Interface](../assets/images/ishare-02.png)
</Frame>
</Step>
...
<Frame>
  ![Keyboard Shortcuts](../assets/images/ishare-03.png)
</Frame>
</Step>
...
<Frame>
  ![After capture tasks](../assets/images/ishare-04.png)
</Frame>
</Step>
...
<Frame>
  ![After upload tasks](../assets/images/ishare-05.png)
</Frame>
</Step>
...
<Frame>
![Setup iOS imagehost shortcut](../assets/images/shortcuts-01.png)
</Frame><br/><br/>
...
<Frame>
![Add shortcut to control center](../assets/images/shortcuts-02.png)
</Frame>
...
<Frame>
![Show in Share-Sheet](../assets/images/shortcuts-03.png)
</Frame>
...
<Frame>
![Upload image in clipboard](../assets/images/shortcuts-04.png)
</Frame>
...
<Frame>
  ![Make Flameshot script executable](../assets/images/flameshot-01.png)
</Frame>
</Step>
...
<Frame>
  ![Test Flameshot script](../assets/images/flameshot-02.png)
</Frame>
</Step>
...
<Steps>
  ...
  <Step title="Open File">
    ...
    <Frame>
    ![ShareX Overlay File](../assets/images/sharex-overlay-01.png)
    </Frame>
...
<Frame>
  ![ShareX Overlay Example](../assets/images/sharex-overlay-example.png)
</Frame>
...
<Frame>
  ![ShareX After capture tasks](../assets/images/sharex-overlay-02.png)
</Frame>
</Tip>
...
<Frame>
  ![Embed Settings Interface](../assets/images/imagehost_embed_settings.png)
</Frame>
  ...
  <Tab title="Manual Upload">
    <Steps>
      ...
      <Step title="Done">
        ...
        <Frame>
          ![Image Host Upload Interface](../assets/images/imagehost_upload.png)
        </Frame>
      </Step>
    </Steps>
  </Tab>
...
<Steps>
  ...
  <Step title="Create Folder">
    ...
    <Frame>
      ![Create Folder Interface](../assets/images/folders-02.png)
    </Frame>
  </Step>
  ...
  <Step title="Done">
    ...
    <Frame>
      ![Move file into folder interface](../assets/images/folders-03.png)
    </Frame>
    ...
    <Frame>
      ![Image Host Folders Interface](../assets/images/folders-01.png)
    </Frame>
...
<Steps>
  ...
  <Step title="Create Rule">
    ...
    <Frame>
      ![Create Rule Interface](../assets/images/folders-04.png)
    </Frame>
  </Step>
  <Step title="Done">
...
<Steps>
  <Step title="Open the Gallery section on the dashboard">
    ...
    <Frame>
      ![Image Host Gallery Interface](../assets/images/imagehost_gallery.png)
    </Frame>
  </Step>
</Steps>
...
<Info>
The Image Host subscription with the most storage and the largest file size limit can be purchased [here](https://haunt.gg/pricing#imagehost). If you purchase this product, you will also receive the [Image Host badge](https://help.haunt.gg/customization/badges#image-host).
</Info>
